...
const challenges: ChallengeData[] = [
  ...
  // ═══ HARD TIER (10) ═══
  { title:'SQLiLogin',            category:'web',difficulty:'hard',points:400,flag:'CGS{w4f_byp4ss_un10n_3xtr4ct10n_1s_h4rd}',     hint:'The WAF blocks common SQLi keywords — but can you bypass it? The flag is NOT in the users table.',                           instanceUrl:null, description:'CGS\'s admin login uses string-concatenated SQL and a WAF that blocks common injection keywords. A successful login alone won\'t give you the flag — it\'s stored in a separate secrets table. You\'ll need to bypass the WAF and use UNION-based injection to extract it.' },
