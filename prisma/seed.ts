...
const challenges: ChallengeData[] = [
  ...
  { title:'PixelArchive',         category:'web',difficulty:'easy',points:100,flag:'CGS{3x1f_d4t4_hu6h_wh0_kn3w}',                 hint:'The flag isn\'t on the page. It\'s inside a file the page links to.',                                                        instanceUrl:null, description:'A photographer\'s online portfolio, all clean grids and moody captions. Cameras — and the files they produce — remember more than the photographer intended to share.' },
  ...
  { title:'StyleGuide',           category:'web',difficulty:'easy',points:100,flag:'CGS{ext3rn4l_css_h4s_c0mm3nts_t00}',          hint:'The page loads more files than just its own HTML. Check what it links to.',                                                  instanceUrl:null, description:'CGS\'s design team published their internal style guide. Everything looks buttoned-up on the page — but the stylesheet powering it was written by a developer who forgot that comments ship to production too.' },
  ...
  { title:'HiddenAPI',            category:'web',difficulty:'medium',points:250,flag:'CGS{th3_ui_1sn7_th3_wh0l3_4p1_surf4c3}',     hint:'The page\'s visible requests aren\'t the only endpoints this app knows about.',                                               instanceUrl:null, description:'CGS\'s analytics dashboard only shows public stats — but the JavaScript that powers it was bundled straight from source, internal routes and all.' },
  { title:'IDOR Inbox',           category:'web',difficulty:'medium',points:250,flag:'CGS{1nc0rr3ct_d1r3ct_0bj3ct_r3f3r3nc3s}',   hint:'Look at the URL the app uses to fetch your messages. What\'s driving it?',                                                  instanceUrl:null, description:'CGS Mail shows you your inbox — messages fetched by a simple numeric ID. Nobody ever checked whether that ID has to belong to you.' },
  ...
  { title:'RateDodge',            category:'web',difficulty:'medium',points:250,flag:'CGS{sp00f3d_h34d3rs_r3s3t_r4t3_l1m1ts}',     hint:'How does the server figure out which IP to rate-limit?',                                                                   instanceUrl:null, description:'CGS\'s demo API rate-limits one request per IP per minute — but it\'s asking the client to tell them which IP it\'s coming from.' },
