...
const challenges: ChallengeData[] = [
  {
    ...
    category: 'web', difficulty: 'easy', points: 75,
  ...
  },
  {
    ...
    category: 'crypto', difficulty: 'easy', points: 50,
  ...
  },
  {
    ...
    category: 'forensics', difficulty: 'easy', points: 75,
  ...
  },
  {
    ...
    category: 'misc', difficulty: 'easy', points: 50,
  ...
  },
  {
    ...
    category: 'web', difficulty: 'medium', points: 225,
  ...
  },
  {
    ...
    category: 'crypto', difficulty: 'medium', points: 300,
  ...
  },
  {
    ...
    category: 'reverse', difficulty: 'medium', points: 300,
  ...
  },
  {
    ...
    category: 'misc', difficulty: 'medium', points: 275,
  ...
  },
  {
    ...
    category: 'crypto', difficulty: 'hard', points: 500,
  ...
  },
  {
    ...
    category: 'forensics', difficulty: 'hard', points: 475,
  ...
  },
  {
    ...
    category: 'reverse', difficulty: 'hard', points: 500,
  ...
  },
  {
    ...
    category: 'misc', difficulty: 'hard', points: 500,
    flag: 'CGS{ch41n3d_bugs_ar3_th3_r34l_thr34t}',
    hint: 'One door doesn\'t open the room, it opens the next door.',
    files: JSON.stringify([{name:'encrypted.bin'},{name:'source_code.js'},{name:'key_hint.txt'},{name:'final_message.txt'}]),
  },
]
...
async function seedChallenges() {
  ...
  console.log(`[OK] ${count} new challenges seeded (${total} total in database)`)
}
