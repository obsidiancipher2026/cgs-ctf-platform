...
const challenges: ChallengeData[] = [
  ...
  {
    title: 'Login Free',
    description: 'The admin panel is protected by a mysterious login form. But the form is just for show — the real entry point is where they forgot to lock the door.',
    category: 'web', difficulty: 'easy', points: 100,
    flag: 'CGS{1ntr0sp3ct10n_1s_th3_r34l_k3y}',
    hint: 'The backend speaks a hidden language. Ask it what queries it accepts.',
    instanceUrl: null,
  },
  {
    title: 'Hidden Input',
    description: 'The registration form asks for a lot of information. Some of it is more visible than others.',
    category: 'web', difficulty: 'easy', points: 100,
    flag: 'CGS{h1dd3n_f13lds_d0nt_st0p_4ny0n3}',
    hint: 'The browser knows more than it shows.',
    instanceUrl: null,
  },
  {
    title: 'View Source',
    description: 'The developer made the JavaScript really, really hard to read. Maybe that was the point.',
    category: 'web', difficulty: 'easy', points: 100,
    flag: 'CGS{m1n1f13d_d03snt_m34n_h1dd3n}',
    hint: 'Pretty-printing is a developer\'s best friend.',
    instanceUrl: null,
  },
  {
