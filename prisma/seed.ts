...
const challenges: ChallengeData[] = [
  ...
  { title:'IDOR Inbox',           category:'web',difficulty:'medium',points:250,flag:'CGS{1d0r_1s_num3r1c_bl1ndn3ss}',             hint:'Our security team says the login form is rock solid \u2014 no SQL injection, no weak passwords, no session hijacking possible here. The real question is: once you\'re in, does the app actually check if the profile you\'re looking at is *yours*?', instanceUrl:null, description:'CGS Inbox lets employees view team profiles. After logging in, your profile loads with a Base64-encoded ID in the URL. The app trusts you to look at your own profile \u2014 but does it actually verify that you are?' },
