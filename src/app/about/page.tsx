          ...
          <div className="flex flex-col sm:flex-row justify-center gap-8 items-center">
            <div className="cyber-card rounded-2xl p-6 sm:p-8 w-72 flex flex-col items-center">
              ...
              <div className="flex items-center justify-center gap-3 mt-3">
                ...
                <a href="mailto:sakingplays@gmail.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-cyber-red transition-colors"><Mail className="w-4 h-4" /></a>
              </div>
            </div>
            <div className="cyber-card rounded-2xl p-6 sm:p-8 w-72 flex flex-col items-center">
              ...
              <div className="flex items-center justify-center gap-3 mt-3">
                ...
                <a href="mailto:mrgill2792@gmail.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-cyber-red transition-colors"><Mail className="w-4 h-4" /></a>
              </div>
            </div>
          </div>
        </motion.div>
