      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-16">
        ...
        <div className="mt-8 flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0 space-y-8">
            ...
            {challenge.instanceType === 'web' && !challenge.dockerImage && challenge.instanceUrl && (
              <motion.div
              ...
              >
                <div className="p-5">
                  ...
                  >
                    ...
                    <span className="truncate">{challenge.instanceUrl}</span>
                  </a>
                </div>
              </motion.div>
            )}

            {challenge.instanceType === 'web' && challenge.dockerImage && (
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
                <ChallengeInstance
                  slug={challenge.slug}
                  instanceType={challenge.instanceType}
                  instanceUrl={challenge.instanceUrl}
                  instanceTTL={challenge.instanceTTL}
