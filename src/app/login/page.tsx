        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/40 rounded-lg px-4 py-3 text-xs text-yellow-200 flex items-start gap-2.5">
              ...
              <p><strong>Admin Approval Required:</strong> New accounts must be approved by an administrator before you can access the platform. You will be notified once your account is approved.</p>
            </div>
